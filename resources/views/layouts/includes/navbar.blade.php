        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item " href="{{asset('blog-single')}}">Blog Single</a>
              <a class="dropdown-item " href="{{asset('agents-grid')}}">Agents Grid</a>
              <a class="dropdown-item " href="{{asset('agent-single')}}">Agent Single</a>
            </div>
          </li>
          <li class="nav-item">
